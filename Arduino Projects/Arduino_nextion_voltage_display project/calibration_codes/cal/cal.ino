...
float windowLength = 40 / testFrequency;     // how long to average the signal, for statistist, changing this can have drastic effect
// Test as you need
...
float ReadVoltage() {
  RawValue = analogRead(A3);  // read the analog in value:
